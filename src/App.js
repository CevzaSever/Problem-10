...
function Card({ username ,date,text}) {
  return (
...
export default function App() {
  return (
    <div className="bg-gray-100">
      <Card username="Chelsea Hagon"  date="9 Aralık saat 11:43" text=" Lorem ipsum dolor sit, amet consectetur adipisicing elit. Illo
